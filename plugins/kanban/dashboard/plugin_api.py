...
def _run_estimate(title: str, body: Optional[str]) -> dict:
    ...
    # Always attach live local-endpoint readiness so the UI can show whether
    # a "local" lane recommendation is actually runnable right now (DS4 /
    # Spark / MBP Ollama). Cheap probes; never fails the estimate.
    try:
