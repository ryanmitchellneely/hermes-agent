# SIG-20260825-01 — Perplexity Portable Computer: their full agent runtime local on DGX Spark, benchmarked AGAINST hermes-agent (our upstream). Harness ablation is the gift; adviser-rung escalation is the steal.
...
**SIG-20260825-01** · harness · **steal P1** · medium
