# A P0: Audit + pin cron models to Grok (stop Opus inherit)

```yaml
id: mesh_done_card:t_dc98790d@0
source_kind: mesh_done_card
source_path: t_dc98790d
source_ref: t_dc98790d@0
board: mesh
...
**Parent epic:** mesh efficiency B23
