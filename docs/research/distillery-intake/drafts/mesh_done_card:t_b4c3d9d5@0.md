# HUMAN: T1000 backup hour — remote, push, FileVault, chmod (do FIRST)

```yaml
id: mesh_done_card:t_b4c3d9d5@0
source_kind: mesh_done_card
source_path: t_b4c3d9d5
source_ref: t_b4c3d9d5@0
board: mesh
...
Sprint: S0-preserve. Unblock: Ryan runs it (~1h, zero decisions).
