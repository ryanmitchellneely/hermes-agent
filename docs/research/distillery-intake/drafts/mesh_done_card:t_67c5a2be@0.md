# C P1: Session hygiene pass (state.db ~327MB)

```yaml
id: mesh_done_card:t_67c5a2be@0
source_kind: mesh_done_card
source_path: t_67c5a2be
source_ref: t_67c5a2be@0
board: mesh
...
**Skill:** hermes-session-hygiene (mandatory)
