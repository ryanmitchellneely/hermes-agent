# Pulp: calendar domain or honest gap

```yaml
id: mesh_done_card:t_cdec6dce@1
source_kind: mesh_done_card
source_path: t_cdec6dce
source_ref: t_cdec6dce@1
board: mesh
...
WHY: Ryan asked calendar twice on TG; no domain today.
